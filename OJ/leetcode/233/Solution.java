class Solution {
    /**
     * 参考链接：https://leetcode-cn.com/problems/number-of-digit-one/solution/gong-shui-san-xie-jiang-shu-wei-dp-wen-t-c9oi/
     * @param n
     * @return
     */
    ...
    public static void main(String[] args) {
        ...
        int n = 1000000000;
        System.out.println("test: " + sol.countDigitOne(n));
    }
}